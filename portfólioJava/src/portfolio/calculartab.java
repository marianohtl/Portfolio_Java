...
public class calculartab extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					calculartab frame = new calculartab();
	...
	public calculartab() {
		...
		lblValor4.setForeground(SystemColor.text);
		...
		lblValor7.setForeground(SystemColor.text);
		...
		lblValor5.setForeground(SystemColor.text);
		...
		lblValor6.setForeground(SystemColor.text);
		...
		lblValor8.setForeground(SystemColor.text);
		...
		lblValor10.setForeground(SystemColor.text);
		...
		lblMult10.setForeground(SystemColor.text);
		lblMult10.setBounds(108, 304, 46, 14);
		contentPane.add(lblMult10);
		
		lblResult10 = new JLabel("");
		lblResult10.setForeground(SystemColor.text);
		...
		lblTabuada.setForeground(SystemColor.menu);
		...
		label_5.setForeground(SystemColor.text);
